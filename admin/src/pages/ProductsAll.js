...
const ProductsAll = () => {
  ...
  useEffect(() => {
    setDatas(products?.slice((page - 1) * resultsPerPage, page * resultsPerPage));
              ...
              <TableBody>
                {datas?.map((product) => (
                  <TableRow key={product.id}>
                    <TableCell>
                      <div className="flex items-center text-sm">
                        <Avatar
                          ...
                          src={baseURLImg + product?.attributes?.productImg?.data[0].attributes?.url}
                          alt="Product image"
                        />
                        <div>
                          <p className="font-semibold">{product?.attributes?.productName}</p>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell className="text-sm">{product?.attributes?.productQuantity}</TableCell>
                    <TableCell className="text-sm">{product?.attributes?.productPrice}</TableCell>
                    <TableCell>
                      <div className="flex">
                        ...
                        <Button
                          icon={TrashIcon}
                          layout="outline"
                          onClick={() => openModal(product?.attributes?.productName, product.id)}
                          aria-label="Delete"
                        />
                      </div>
                    </TableCell>
                ...
                <Card>
                  ...
                  <CardBody>
                    ...
                    <p className="mb-8 text-gray-600 dark:text-gray-400">
                      {product?.attributes?.productDesc.slice(0, 80) + '...' + product?.attributes?.productDesc.slice(-20)}
                    </p>

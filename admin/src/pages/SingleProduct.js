  ...
  return (
    <div>
      ...
      <div className="flex text-gray-800 dark:text-gray-300">
        ...
        {">"}
        <p className="mx-2">{productId[0]?.attributes?.productName}</p>
      </div>
      ...
      <Card className="my-8 shadow-md">
        <CardBody>
          <div className="grid grid-col items-center md:grid-cols-2 lg:grid-cols-2">
            <div>
              <img src={baseURLImg + productId[0]?.attributes?.productImg?.data[0].attributes?.url} alt="" className="w-9/12 rounded-lg" />
            </div>

                ...
                <TableContainer className="mb-8">
                    <Table>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center text-sm">
                                            <Avatar
                                                ...
                                                src={baseURLImg + brand?.attributes?.brandImg?.data[0].attributes?.url}
                                                alt="Product image"
                                            />
                                            <div>
                                                <p className="font-semibold">{brand?.attributes?.brandName}</p>
                                            </div>
                                        </div>
                                    </TableCell>
                                    <TableCell>
                      ...
                      {genRating(product.rating, product.reviews.length, 5)}
                                    ...
                                    <TableCell className="text-sm">{brand?.attributes?.brandDesc.slice(0, 70)} ...</TableCell>
                                    <TableCell>
                                        <div className="flex">

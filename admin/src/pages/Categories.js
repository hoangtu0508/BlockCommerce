...
const Categories = () => {
    const { getAllCategories, categories, handleDeleCategory } = useContext(Context);
    ...
    useEffect(() => {
        setData(categories?.slice((page - 1) * resultsPerPage, page * resultsPerPage));
                ...
                <TableContainer className="mb-8">
                    <Table>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center text-sm">
                                            <Avatar
                                                ...
                                                src={baseURLImg + category?.attributes?.categoryImg?.data[0].attributes?.url}
                                                alt="Product image"
                                            />
                                            <div>
                                                <p className="font-semibold">{category?.attributes?.categoryName}</p>
                                            </div>
                                        </div>
                                    </TableCell>
                                    <TableCell>
                      ...
                      {genRating(product.rating, product.reviews.length, 5)}
                                    ...
                                    <TableCell className="text-sm">{category?.attributes?.categoryDesc.slice(0, 60) + "..." + category?.attributes?.categoryDesc.slice(-10)}</TableCell>
                                    <TableCell>
                                        <div className="flex">

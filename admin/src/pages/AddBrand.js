...
const AddBrand = () => {
    const { handleNewBrand, getAllBrands, brands } = useContext(Context)
    ...
    const handleAddBrand = async () => {
        await handleNewBrand(image, updatesData)
        await getAllBrands()
    }
    return (
        <div>
            ...
            <div className="w-full mt-8 grid gap-4 grid-col md:grid-cols-3 ">
                <Card className="row-span-2 md:col-span-2">
                    <CardBody>
                        ...
                        <div className="w-full" onClick={() => handleAddBrand()}>
                        ...
                        <Label className="mt-4">
                            ...
                            {show && (
                                <div>
                                    <ul>
                                        {brands?.map((brand) => (
                                            <li key={brand.id} className="my-2">{brand?.attributes?.brandName}</li>
                                        ))}
                                    </ul>
                                </div>
                            )}

...
const EditBrand = () => {
    ...
    const { getBrandId, brandId, editBrand, getAllBrands } = useContext(Context)
    ...
    useEffect(() => {
        setUpdatesData(brandId?.data[0].attributes)
    }, [brandId])
    ...
    const handleEditBrand = async () => {
        await editBrand(id, image, updatesData)
        await getAllBrands()
        history.push("/app/all-brand")
    }
                    ...
                    <CardBody>
                            ...
                            <div class="media flex justify-center mt-3">
                                ...
                                <div class="media-img w-1/2 ml-3">
                                    {imageUrl ? (
                                        ...
                                        <img src={`${baseURLImg + updatesData?.brandImg?.data[0]?.attributes?.url}`} alt="Product Image" className="w-auto h-40" />
                                    )}
                        ...
                        <Label>
                            <Textarea
                                ...
                                onChange={(e) => updateEdit(e)}
                                id="brandDesc"
                                value={updatesData?.brandDesc}
                            />
                        </Label>

                        <div className="w-full" onClick={() => handleEditBrand()}>
                    ...
                    <CardBody>
                        ...
                        <Label className="mt-4">
                            ...
                            {show && (
                                <div>
                                    <ul>
                                        {brandId?.data[0]?.attributes?.products?.data?.map((product) => (
